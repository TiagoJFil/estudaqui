...
async def process_image(image_link, file_name, page_number,exam_name) -> dict:
    ...
    question_numbers_and_images = {
        question["questionNumber"]: { "images": question.get("imgCount", 0) } for question in questions
    }
    print(f"Generated question_numbers_and_images for page {page_number}: {question_numbers_and_images}")
    ...
    body = {
        ...
        "pages": {
            str(page_number): question_numbers_and_images
        }
    }
